...
export default function IncidentsPage() {
  ...
  return (
    <div className="p-6 min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-gray-100">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold text-blue-400">📅 Manage Incidents / Appointments</h1>
        <button 
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left bg-gray-700 text-gray-100 rounded shadow">
